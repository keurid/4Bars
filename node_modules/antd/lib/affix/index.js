...
const InternalAffix = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  var _a;
  const {
    style,
    offsetTop,
  ...
  let otherProps = (0, _omit.default)(props, ['prefixCls', 'offsetTop', 'offsetBottom', 'target', 'onChange', 'affixPrefixCls', 'rootClassName']);
  if (process.env.NODE_ENV === 'test') {
